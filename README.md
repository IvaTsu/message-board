...
## Basic Info
This project is a simple app that works with React, Firebase and Redux to create a message applicatin, so that user will be able to add messages with the Title and Body and also will be able to delete them.
